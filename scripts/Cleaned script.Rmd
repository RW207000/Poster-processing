...
```{r : reading in data}
all_participants <- read.csv("C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/data/CO-ID_202403_NK CaHASE2 CAH 160924.csv", header=T, na.strings= c("", "NA"))
all_participants$Date...CAH.Longitudinal.Data <- as.Date(all_participants$Date...CAH.Longitudinal.Data, format = "%d/%m/%Y")

participants <- all_participants %>%
  filter(Date...CAH.Longitudinal.Data > "2022-12-01")

all_medication <- read.csv("C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/data/CO-ID_202403_NK CaHASE2_CAH study Meds_extract_19.09.24 (original).csv", header=T, na.strings= c("", "NA"))
all_medication <- remove_empty(all_medication, c("cols"), cutoff = 1)
all_medication$assessment_date <- as.Date(all_medication$assessment_date, format = "%d/%m/%Y")

medication <- all_medication %>%
  filter(assessment_date > "2022-12-01")

all_labs <- read.csv("C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/data/CO-ID_202403_NK CaHASE2_CAH study Labs_extract_16.9.24.csv", header=T, na.strings= c("", "NA"))
all_labs$assessment_date <- as.Date(all_labs$assessment_date, format = "%d/%m/%Y")
...
write.csv(removedrecords, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/removedrecords.csv", row.names = F)
```
...
write.csv(lostparticipants, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/lostparticipants.csv", row.names = F)
```
...
write.csv(sex, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/sex.csv", row.names = F)
...
write.csv(visitstatspercentre_Dec2023_Dec2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/visitstatspercentre_Dec2023_Dec2024.csv", row.names = F)
write.csv(visitstatspercentre_Dec2022_Dec2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/visitstatspercentre_Dec2022_Dec2023.csv", row.names = F)
```
...
write.csv(centredata, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/centredata.csv", row.names = F)
```
...
write.csv(ageframe2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/ageframe2022_2023.csv", row.names = F)
write.csv(ageframe2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/ageframe2023_2024.csv", row.names = F)
...
write.csv(overallvisitsstats, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/overallvisitsstats.csv", row.names = F)
```
...
write.csv(prescriptions, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/prescriptions.csv", row.names = F)
...
write.csv(prescriptions_2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/prescriptions_2023_2024.csv", row.names = F)
...
write.csv(prescriptions_2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/prescriptions_2022_2023.csv", row.names = F)
...
write.csv(hydrocortisonestats, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/hydrocortisonestats.csv", row.names = F)
...
write.csv(hydrocortisonestats_2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/hydrocortisonestats_2023_2024.csv", row.names = F)
...
write.csv(hydrocortisonestats_2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/hydrocortisonestats_2022_2023.csv", row.names = F)
...
write.csv(prednisolonestats, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/prednisolonestats.csv", row.names = F)
...
write.csv(prednisolonestats_2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/prednisolonestats_2023_2024.csv", row.names = F)
...
write.csv(prednisolonestats_2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/prednisolonestats_2022_2023.csv", row.names = F)
...
write.csv(dexamethasonestats, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/dexamethasonestats.csv", row.names = F)
...
write.csv(dexamethasonestats_2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/dexamethasonestats_2023_2024.csv", row.names = F)
...
write.csv(dexamethasonestats_2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/dexamethasonestats_2022_2023.csv", row.names = F)
```
...
write.csv(overallvisitspercentre_2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/overallvisitspercentre_2022_2023.csv", row.names = F)
write.csv(overallvisitspercentre_2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/overallvisitspercentre_2023_2024.csv", row.names = F)
write.csv(entryrecords, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/entryrecords.csv", row.names = F)
```
...
write.csv(BMIstats2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/BMIstats2023_2024.csv", row.names = F)
...
write.csv(BMIstats2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/BMIstats2022_2023.csv", row.names = F)
```
...
write.csv(OHPframe_2023_2024, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/OHPframe_2023_2024.csv", row.names = F)
write.csv(OHPframe_2022_2023, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Oct2024/My versions/Cleaned/Cleaned processing/outputs/OHPframe_2022_2023.csv", row.names = F)
```
