...
totaldailyformedswide <- medperpatient %>%
  select(Assessment.ID, total_standardised_daily_dose)
totaldailyformedswide <- totaldailyformedswide %>%
  rename("assessment_id" = "Assessment.ID")
  
medperpatient <- medperpatient %>%
  rename("assessment_id" = "Assessment.ID")
...
meds_wide <- left_join(meds_wide, test2, by = c("assessment_id"))
