...
Age, sex, medication, height, weight, BMI, blood pressure, biomarkers, genotype, co-morbidities and fertility/pubity/menstrual information.
...
minimal_data <- left_join(minimal_data, meds_wide_no_duplicates, by = c("CO.ID_assessment_date"))
minimal_data <- left_join(minimal_data, biomarkers_no_duplicates, by = c("CO.ID_assessment_date"))

write.csv(minimal_data, file = "C:/Users/md1rwe/Documents/Data extractions from I-CAH/Feb 2025/I-CAH_data_Feb_2025/outputs/minimal_data.csv", row.names = FALSE, na = "")
```
...
missing_data_per_centre <- minimal_data %>%
  group_by(`Centre ID`) %>%
